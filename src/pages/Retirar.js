...
export default function Retirar({ agregarMovimiento, saldo }) {
  ...
  const handleConfirmar = () => {
    ...
    agregarMovimiento("Gasto", "Retiro de efectivo", -montoNum);
  ...
  return (
    <div className="min-h-screen bg-fondo p-6">
      <h2 className="text-2xl font-bold text-primario mb-6">🏧 Retirar</h2>
      <input
        type="number"
        value={monto}
